...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-hidden">
      ...
      {/* Pink header */}
      <div className="relative bg-primary flex-shrink-0" style={{ minHeight: 230 }}>
        ...
        >
          <h1 className="text-2xl sm:text-3xl font-bold text-white leading-tight">Log in to your account</h1>
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="flex-1 bg-white px-5 sm:px-6 pt-2 pb-10 max-w-md w-full mx-auto"
      >
        ...
        <motion.p variants={fadeUp} className="text-center text-[11px] text-gray-400 mt-4 leading-relaxed">
